...
블로그에 적용한 테마마다 UI/UX 수정 방법이 조금씩 다르다고 합니다. 본인이 선택하신 테마 제작자의 문서나 검색을 통해 입맛에 맞게 수정하여 사용하시면 됩니다.<br/> 저도 제가 적용한 minimal-mistakes 테마를 좀 뜯어보고 익숙해지면 추후 테마 수정 방법에 대해 다시 포스팅해 보도록 하겠습니다. 다들 즐겁고 알차게 블로그를 채워나가시길 바랍니다.<br/><br/>
